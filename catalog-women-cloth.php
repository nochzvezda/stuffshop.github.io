...
$products = mysqli_query($connect, "SELECT * FROM products_women_cloth");
...
<main>
    ...
    <section class="catalog">
        ...
        <h2 class="visually-hidden">Женская одежда 2023</h2>
                            ...
                            <li class="catalog-grid__item">
                                <article class="product-catalog">
                                    <div class="product-catalog__image">
                                        ...
                                        <?php echo  "<a href='card_women_cloth.php?id_product=".$result['id_product']."'>";?><?php echo $result['name'] ?></a>
                                        </h3>
...
<?php $sale = mysqli_query($connect, "SELECT * FROM products_women_cloth LIMIT 3");?>
  ...
  ?>
            <li class="catalog-grid__item">
                <article class="product-catalog">
                    ...
                    <h3 class="product-catalog__title">
                    <?php echo  "<a href='card_women_cloth.php?id_product=".$sale_result ['id_product']."'>";?><?php echo $sale_result ['name'] ?></a>
                    </h3>
