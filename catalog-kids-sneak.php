...
<main>
    ...
    <section class="catalog">
        ...
        <h2 class="visually-hidden">Детская обувь 2023</h2>
                            ...
                            <div class="catolog-filter__bottom catalog-filter__bottom">
                                <ul class="catalog-filter__items">
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">20</span>
                                        </label>
                                    </li>
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">21</span>
                                        </label>
                                    </li>
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">22</span>
                                        </label>
                                    </li>
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">23</span>
                                        </label>
                                    </li>
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">24</span>
                                        </label>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <li class="catalog-grid__item">
                                <article class="product-catalog">
                                    <div class="product-catalog__image">
                                        ...
                                        <?php echo  "<a href='card.php?id_product=".$result['id_product']."'>";?><?php echo $result['name'] ?></a>
                                        </h3>
...
<?php $sale = mysqli_query($connect, "SELECT * FROM products LIMIT 3");?>
  ...
  ?>
            <li class="catalog-grid__item">
                <article class="product-catalog">
                    ...
                    <h3 class="product-catalog__title">
                    <?php echo  "<a href='card.php?id_product=".$sale_result ['id_product']."'>";?><?php echo $sale_result ['name'] ?></a>
                    </h3>
...
<?php $slider = mysqli_query($connect, "SELECT * FROM products");?>
<section class='mens-slider'>
  ...
  ?>
    ...
    <?php echo  "<a href='card.php?id_product=".$slider_result['id_product']."'>";?><img src="<?php echo $slider_result['name_img'] ?>"></a>
    </div>
    <?php
   }
  ?>
