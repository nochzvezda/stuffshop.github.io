...
$select_product = "SELECT * FROM products_men_sneakers WHERE id_product= '$id_product';";
$select_img = "SELECT img_product_men_sneakers.id_product, img_men_sneakers.name_img 
FROM img_product_men_sneakers
JOIN products_men_sneakers ON products_men_sneakers.id_product = img_product_men_sneakers.id_product
JOIN img_men_sneakers ON img_product_men_sneakers.id_img = img_men_sneakers.id_img
WHERE img_product_men_sneakers.id_product = '$id_product';";
