...
<body>
    <div class="container__admin">
        ...
        <div class="title_table">
            ...
            $qInfoUser = "SELECT * FROM employees";
            ...
            while($InfoUser = mysqli_fetch_object($resInfoUser)){
                ...
                <tr class=\"table_row\">
                    <td>
                    <a href=\"?idD=$InfoUser->id_employee\"><img src=\"./img/info-error.svg\" width=\"10px\"></a>
                    </td>
                    <td>$InfoUser->id_employee</td>
...
if (isset($_GET['idD'])){
    $userD = $_GET['idD'];
    $qDeleteUser = "DELETE FROM `employees` WHERE `id_employee` = '$userD'";
