...
$products = mysqli_query($connect, "SELECT * FROM products_women_sneakers");
...
<main>
    <div class="container hero__container-catalog">
        <ul class="breadcrumb">
            ...
            <li><a href="womens.php">Женщинам</a></li>
            <li>Обувь</li>
        </ul>
    </div>
    ...
    <section class="catalog">
        ...
        <h2 class="visually-hidden">Женская обувь 2023</h2>
                            ...
                            <div class="catolog-filter__bottom catalog-filter__bottom">
                                <ul class="catalog-filter__items">
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">36</span>
                                        </label>
                                    </li>
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">37</span>
                                        </label>
                                    </li>
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">38</span>
                                        </label>
                                    </li>
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">39</span>
                                        </label>
                                    </li>
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">40</span>
                                        </label>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <li class="catalog-grid__item">
                                <article class="product-catalog">
                                    <div class="product-catalog__image">
                                        ...
                                        <?php echo  "<a href='card_women_sneakers.php?id_product=".$result['id_product']."'>";?><?php echo $result['name'] ?></a>
                                        </h3>
...
<?php $sale = mysqli_query($connect, "SELECT * FROM products_women_sneakers LIMIT 3");?>
  ...
  ?>
            <li class="catalog-grid__item">
                <article class="product-catalog">
                    ...
                    <h3 class="product-catalog__title">
                    <?php echo  "<a href='card_women_sneakers.php?id_product=".$sale_result ['id_product']."'>";?><?php echo $sale_result ['name'] ?></a>
                    </h3>
