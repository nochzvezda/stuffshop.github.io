...
$select_product = "SELECT * FROM products_kids_cloth WHERE id_product= '$id_product';";
$select_img = "SELECT img_product_kids.id_product, img_kids.name_img 
FROM img_product_kids
JOIN products_kids_cloth ON products_kids_cloth.id_product = img_product_kids.id_product
JOIN img_kids ON img_product_kids.id_img = img_kids.id_img
WHERE img_product_kids.id_product = '$id_product';";
        ...
        <div class='container container-narrow'>
            ...
            <div class='card-top__right'>
                <div class='card-info'>
                    ...
                    <button class='btn-ens-action btn-ens-style card-info__btn card-info__btn--tocart' data-rel='73c10d14330148'>
                    Добавить в корзину
</button> <br>
                </div>
            </div>
