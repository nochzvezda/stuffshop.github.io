...
$select_product = "SELECT * FROM products_men_cloth WHERE id_product= '$id_product';";
$select_img = "SELECT img_product_men_cloth.id_product, img_men_cloth.name_img 
FROM img_product_men_cloth
JOIN products_men_cloth ON products_men_cloth.id_product = img_product_men_cloth.id_product
JOIN img_men_cloth ON img_product_men_cloth.id_img = img_men_cloth.id_img
WHERE img_product_men_cloth.id_product = '$id_product';";
        ...
        <div class='container container-narrow'>
            ...
            <div class='card-top__right'>
                <div class='card-info'>
                    ...
                    <button class='btn-ens-action btn-ens-style card-info__btn card-info__btn--tocart' data-rel='73c10d14330150'>
                    Добавить в корзину
</button>
                </div>
            </div>
