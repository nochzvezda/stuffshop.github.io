...
$select_product = "SELECT * FROM products_women_cloth WHERE id_product= '$id_product';";
$select_img = "SELECT img_product_women_cloth.id_product, img_women_cloth.name_img 
FROM img_product_women_cloth
JOIN products_women_cloth ON products_women_cloth.id_product = img_product_women_cloth.id_product
JOIN img_women_cloth ON img_product_women_cloth.id_img = img_women_cloth.id_img
WHERE img_product_women_cloth.id_product = '$id_product';";
