...
$select_img = "SELECT img_product.id_product, img.name_img 
FROM img_product
JOIN products ON products.id_product = img_product.id_product
JOIN img ON img_product.id_img = img.id_img
WHERE img_product.id_product = '$id_product';";
        ...
        <div class='container container-narrow'>
            ...
            <div class='card-top__right'>
                <div class='card-info'>
                    ...
                    <button class='btn-ens-action btn-ens-style card-info__btn card-info__btn--tocart' data-rel='73c10d14330134'>
                    Добавить в корзину
</button>
                </div>
            </div>
