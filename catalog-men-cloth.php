...
$products = mysqli_query($connect, "SELECT * FROM products_men_cloth");
?>
...
<main>
    <div class="container hero__container-catalog">
        <ul class="breadcrumb">
            ...
            <li><a href="mens.php">Мужчинам</a></li>
            <li>Одежда</li>
        </ul>
    </div>
    <section class="catalog">
        <div class="container container__catalog">
        <h2 class="visually-hidden">Мужская одежда 2023</h2>
                            ...
                            <div class="catolog-filter__bottom catalog-filter__bottom">
                                <ul class="catalog-filter__items">
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">xs</span>
                                        </label>
                                    </li>
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">s</span>
                                        </label>
                                    </li>
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">m</span>
                                        </label>
                                    </li>
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">l</span>
                                        </label>
                                    </li>
                                    <li class="catalog-filter__item">
                                        <label class="custom-ckeckbox">
                                            <input type="checkbox" class="custom-ckeckbox__input visually-hidden">
                                            <span class="custom-ckeckbox__text">xl</span>
                                        </label>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <li class="catalog-grid__item">
                                <article class="product-catalog">
                                    <div class="product-catalog__image">
                                        ...
                                        <?php echo  "<a href='card_men_cloth.php?id_product=".$result['id_product']."'>";?><?php echo $result['name'] ?></a>
                                        </h3>
...
<?php $sale = mysqli_query($connect, "SELECT * FROM products_men_cloth LIMIT 3");?>
  ...
  ?>
            <li class="catalog-grid__item">
                <article class="product-catalog">
                    ...
                    <h3 class="product-catalog__title">
                    <?php echo  "<a href='card_men_cloth.php?id_product=".$sale_result ['id_product']."'>";?><?php echo $sale_result ['name'] ?></a>
                    </h3>
...
<?php $slider = mysqli_query($connect, "SELECT * FROM products_men_cloth");?>
<section class='mens-slider'>
  ...
  ?>
    ...
    <?php echo  "<a href='card_men_cloth.php?id_product=".$slider_result['id_product']."'>";?><img src="<?php echo $slider_result['name_img'] ?>"></a>
    </div>
    <?php
   }
  ?>
